...
str = 'http://image.baidu.com/channel/listjson?fr=channel&tag1=%E6%90%9E%E7%AC%91&tag2=%E5%B1%B1%E5%AF%A8&sorttype=0&pn=30&rn=600&ie=utf8&oe=utf-8&1383359035686'
...
arr.each_with_index do |aaaaaa,index|
  name = 'cw'
  photo_category_id = 16
  suffix = 'jpg'
  head_name = aaaaaa.split("sign=")[1].split("/")[0]
